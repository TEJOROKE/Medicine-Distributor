...
class userhome_activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_userhome_activity)
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.mycart -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container, mycart()).commit()
